    ...
    <el-card shadow="hover" class="box-card" @click="getDetail()">
      <div class="content">
        <div class="left">
          ...
          <div class="tip">
            <div class="left">
              <svg t="1701917868231" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="4242" width="14" height="14">
                <path
            ...
            <div class="right">
              <svg t="1701918391878" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="5560" id="mx_n_1701918391879" width="16" height="16">
                <path
                  ...
                  fill="#bfbfbf" p-id="5561"></path>
              </svg>
              <span>{{ hospitalInfo.bookingRule?.releaseTime }}-{{
...
const getDetail = () => {
  $router.push({
    path: "/hospital/", query: { hoscode: props.hospitalInfo.hoscode }
  });
};
</script>
